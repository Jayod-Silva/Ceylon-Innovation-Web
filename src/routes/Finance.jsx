        ...
        <main className="pt-24 sm:pt-28 md:pt-32">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 md:py-20">
            ...
            >
              ...
              >
                The SKYNET Software is designed to revolutionize the finance
                sector by providing a fully integrated digital platform. It
                enhances billing & finance operations, streamlines compliance,
