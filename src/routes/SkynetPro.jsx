                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  ...
                  >
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 md:mb-6">
                      SKY<span className="text-blue-400">NET</span> PRO
                    </h1>

                    <ScrollAnimation delay={0.2}>
                      <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6 md:mb-8 max-w-lg">
                        Ceylon Innovation Provides The Basis For The Tailor Made
                        Applications That Today's Hospitality Business Requires.
                        SKYNET Pro Distributed ERP Offer A Complete Range Of
                        Features For The Hospitality Industry That Addresses
                        Every Requirement. Each Feature Of The SKYNET Pro
                        Distributed ERP Has Been Developed To Address The
                        Complexity And Interconnectivity Of The Various
                        Functions In Hospitality. We Believe The Focal Point Of
                        Every Software Solution Should Be The Simplification And
                        Streamlining Of Your Business Processes To Help You
                        Devote Quality Time To Core Issues Of Business Growth
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  ...
                  >
                    <div className="w-full md:w-[800px] h-auto">
                      <img src={skynetdevices} alt="SKYNET Pro Devices" />
                    </div>
                  </motion.div>
                ...
                <ScrollAnimation delay={0.1}>
                  <div className="text-center mb-12 md:mb-16">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                      Discover what makes SKYNET PRO the ultimate solution for
                    ...
                    >
                      <div>
                        ...
                        <p className="text-gray-600 text-md leading-relaxed">
                          SKYNET Pro is built with simplicity in mind, avoiding
                          unnecessary complexity. Users can be trained quickly
                    ...
                    >
                      <div>
                        ...
                        <p className="text-gray-600 text-md leading-relaxed">
                          ...
                          to adapt and be tailored to meet your specific
                  ...
                  <ScrollAnimation delay={0.3}>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-gray-600 text-md leading-relaxed">
                          SKYNET Pro is intelligent software that automates
                          invoicing, streamlines operations and reduces manual
                  ...
                  <ScrollAnimation delay={0.4}>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-gray-600 text-md leading-relaxed">
                          SKYNET Pro keeps your business running smoothly,
                          managing tables, payments, bills, and kitchen
                  ...
                  <ScrollAnimation delay={0.5}>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-gray-600 text-md leading-relaxed">
                          Our system is carefully designed by talented software
                          and network engineers to protect all your business
