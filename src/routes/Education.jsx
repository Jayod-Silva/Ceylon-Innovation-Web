        ...
        <main className="pt-24 sm:pt-28 md:pt-32">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 md:py-20">
            ...
            >
              ...
              >
                The SKYNET Software for Education streamlines institutional
                operations with powerful features for student information
                management, library and inventory control, and examinations. It
                empowers schools to enhance efficiency and improve
                communication.
              </motion.p>
            </motion.div>
