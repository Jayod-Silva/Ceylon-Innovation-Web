...
import reatailhero from '../assets/reatailhero.png';
import reataildevices from '../assets/reataildevices.png';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                  SKY<span className="text-blue-600">NET</span> RETAIL
                </h1>
              ...
              >
                <ScrollAnimation delay={0.3}>
                  <div className="space-y-6">
                    {['Convenience Stores','Shopping Centers','Commercial Warehouse','Prepared Foods','Services'].map((feature, i) => (
