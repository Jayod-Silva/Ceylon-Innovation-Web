...
import startims from "../assets/starsIMS.svg";
import starsdevices from "../assets/starsdevices.svg";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  ...
                  >
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 md:mb-6">
                      STARS<span className="text-blue-400"> IMS</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                  ...
                  >
                    <div className="w-full md:w-[800px] h-auto">
                      <img src={starsdevices} alt="Stars IMS" />
                    </div>
                  </motion.div>
